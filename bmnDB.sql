...
--
-- Host: localhost:5222:3307
-- Generation Time: Nov 25, 2024 at 03:31 AM
...
INSERT INTO `routeb` (`route_id`, `route_name`, `starting_point`, `destination`, `distance`) VALUES
...
INSERT INTO `signup` (`first_name`, `last_name`, `user_name`, `password2`, `email`, `phone`) VALUES
('kasjdfl', 'jdsl', 'jdslkfjds', '0', 'jksdlkf@jsdlfkj', 12345678),
('k', 'k', 'k', '0', 'karim@gmail', 79),
('Joy', 'Datta', 'Joy2020', '$2y$10$3DDmdmxWKdUDSSNCx8QbJ.guf8jdqa7wlKjXgH0Jw9E9tkqasuCUW', 'lnkdf@lkasdfj', 1796359342);
...
--
ALTER TABLE `admin`
  ADD CONSTRAINT `admin_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `bus_user` (`user_id`);
